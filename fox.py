...
def Map_init():
    ...
    morill_quad = Location("Morill Quad",
    ...
    chapel_gardens = Location("the Chapel Gardens",
    ...
    mckeldin_mall = Location("McKeldin Mall",
    ...
    engineering_fields = Location("the Engineering Fields",
    ...
    paint_branch_trail = Location("Paint Branch Trail",
...
def main():
    ...
    while Foxtudo.found == False or Foxtudo.location != "Beyond":
        ...
        print(" ")
        location_input = input("Enter the location you want to visit: ")
        
        location_format = (sub(r'\s', '_', location_input)).lower() #replace the spaces with underscores and make it lowercase
        location_upper = location_input.upper()
        
        sleep(1)
        
        print(f"Welcome to {location_upper}!") #print where the person is at.
        print(" ")
        response = input("Do you want to take a picture? Enter yes or no: ")
        ...
        if response == "yes":
            ...
            if difference > timedelta(seconds=20): #if the time is greater then 20 seconds...
                ...
                print("greater than 20 seconds")
        
            if location_format == Foxtudo.return_str():
    ...
    if Foxtudo.location == "Beyond!":
        ...
        print("Hey, B! Just checked reddit and people are saying the fox is in town. I think we missed it. :(")
